...
# ╔═╡ 708ac397-a185-463a-811b-3c64d5c322f7
...
md"""
$$\begin{align*}
\textbf{A}& \quad &x'&=y &y'&=-x+y(1-x^2)\\
\textbf{B}& \quad &x'&=y+y^2 &y'&=-0.5x-0.2y-xy+1.2y^2\\
\textbf{C}& \quad &x'&=y+y^2 &y'&=-x+0.2y-xy+1.2y^2
\end{align*}$$
"""

# ╔═╡ 82eefe9b-c8b1-446c-b204-572a27f28538
md"""
Para este ejercicio intentamos hacer un codigo, con la función graficadorRetratoDeFase a continuación. A su vez hacemos un comparativo con el realizado en la pagina siguiente, de donde salen las imagenes.

[https://aeb019.hosted.uark.edu/pplane.html](https://aeb019.hosted.uark.edu/pplane.html)
"""

# ╔═╡ a7a4d02f-5f4a-4cb6-84a4-30575d0095d8
function graficadorRetratoDeFase(sistema, xlim, ylim, nx=10, ny=10)
    vectorfieldplot(sistema, xlim=xlim, ylim=ylim, nx=nx, ny=ny)
end
...
graficadorRetratoDeFase(A, (-3, 3), (-3, 3))

# ╔═╡ 92f11c40-1c20-4265-92b9-5d5c0ca0f2d0
md"""
### Definición del sistema B:
$$x'=y+y^2$$
...
function B(x, y)
    return [y + y^2, -0.5 * x - 0.2 * y - x * y + 1.2 * y^2]
end

# ╔═╡ 1a15b23e-372a-4c71-94f3-24cdd41ad366
graficadorRetratoDeFase(B, (-3, 3), (-3, 3))

# ╔═╡ dfd227ee-4b08-44ff-a4f8-e7b1137cc776
md"""
### Definición del sistema C:
$$x'=y+y^2$$
$$y'=-x+0.2y-xy+1.2y^2$$
"""
...
function C(x, y)
    return [y + y^2, -x + 0.2 * y - x * y + 1.2 * y^2]
end
...
manifest_format = "2.0"
project_hash = "2b74d1842b4bc83494071e3a07d762b90eee277d"
...
git-tree-sha1 = "83ff6b72182bab93d2ca0de10b11d5d89ce1c829"
